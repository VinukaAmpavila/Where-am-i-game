...
@export var enemyhealth = 300
@export var playerdamage = 15
@export var firebdamage = 25
...
func _on_demon_gaware_body_entered(body: Node2D) -> void:
...
func _on_demon_gaware_body_exited(body: Node2D) -> void:
	if body == player:
		chase_timer.start()
